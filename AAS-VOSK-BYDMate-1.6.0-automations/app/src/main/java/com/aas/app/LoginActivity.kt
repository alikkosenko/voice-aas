...
class LoginActivity : AppCompatActivity() {
            ...
            mainHandler.post {
                ...
                when (result) {
                    AuthApi.Result.Valid -> {
                        ...
                        // The process was launched on the login screen. Bring the
                        // complete voice/ADB runtime up immediately after authorization
                        // instead of waiting for another activity/service lifecycle pass.
                        AasRuntime.requireInitialized(applicationContext)
    ...
    private fun startRuntimeRepair() {
        val serviceIntent = Intent(this, VoiceReadyService::class.java).apply {
