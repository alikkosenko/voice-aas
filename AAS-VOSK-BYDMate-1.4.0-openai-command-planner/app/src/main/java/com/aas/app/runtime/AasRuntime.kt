...
object AasRuntime {
    ...
    fun initialize(context: Context) {
        ...
        initialized = true
        // Keep the proven 1.2.8 startup sequence: unpack/load Vosk as soon as
        // the process runtime exists. Authorization still gates service startup,
        // steering-key handling and command execution.
        voice.preload()
    }
